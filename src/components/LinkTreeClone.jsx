...
const LinktreeClone = () => {
    const links = [
        ...
        {
            name: "GitHub",
            url: "https://github.com/rahmate2003",
            icon: (
        ...
        {
            name: "LinkedIn",
            url: "https://linkedin.com/in/rhmtw",
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: "Instagram",
            url: "https://instagram.com/matterizz_",
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: "Spotify",
            url: "https://open.spotify.com/user/55webrffftanbkywm6wg2mzqp?si=myHAD4taT2i9RLEEMsKJTw",
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-700 via-blue-800 to-sky-500 flex flex-col items-center justify-center p-4 animate-gradient-xy">
            <div className="w-full max-w-md backdrop-blur-lg bg-white/15 p-8 rounded-2xl shadow-2xl">
                ...
                <div className="space-y-4">
                    {links.map((link, index) => (
                        <a
                            ...
                            className="group flex items-center justify-between px-6 py-4 bg-white/50 hover:bg-white/60 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-white/5 backdrop-blur-sm animate-fade-in"
                            style={{ animationDelay: `${index * 150}ms` }}
                        >
                            <span className="flex items-center">
                                <span className="transform transition duration-500 group-hover:rotate-12">
                                    {link.icon}
                                </span>
                ...
                {/* Footer
                <div className="mt-8 text-center text-sm text-gray-400 animate-fade-in-up" style={{ animationDelay: '800ms' }}>
                    ©Your Name. {new Date().getFullYear()}. All rights reserved.
                </div> */}
            </div>
        </div>
    );
